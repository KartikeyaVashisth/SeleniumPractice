...
public class WebDriverTest {
	...
	public static void main(String[] args) {
		...
		//Before v4.6.0, we needed to configure the .exe files(binaries) but post 4.6.0 version, no need to configure .exe files. No need to worry about compatibility issues.
